...
public class FieldNode implements FieldVisitor {
    ...
    public void visitEnd() {
        ...
        if (constantPool != null) {
            this.constantPool = null; // This releases the reference to the ConstantPool
            // passed by ClassNode.
            // Parse attributes
            List<NamedAttributeInstance<?>> attributes = this.attributes;
            for (NamedAttributeInstance<?> instance : attributes) {
